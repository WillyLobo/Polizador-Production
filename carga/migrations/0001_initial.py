# Generated by Django 3.2.4 on 2021-07-14 14:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departamento_nombre', models.TextField(unique=True, verbose_name='Nombre Departamento')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Localidad',
            fields=[
                ('localidad_nombre', models.TextField(unique=True, verbose_name='Nombre Localidad')),
                ('id', models.IntegerField(primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('obra_empresa', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='carga.empresa', verbose_name='Empresa')),
                ('obra_localidad', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='carga.localidad')),
                ('obra_programa', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='carga.programa')),
            ],
            options={
                'verbose_name': 'Obra',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certificado_monto_pesos', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, verbose_name='Monto en UVI')),
